---
name: zotero
description: Compatibility wrapper for local Zotero library operations. Prefer research-lookup as the primary entry point for local library discovery, BibTeX export, and citation-source routing; use this skill only when the explicit Zotero helper commands are needed.
---

# Zotero

Use this skill only as a compatibility wrapper around local Zotero Desktop operations.

Prefer `research-lookup` for local library discovery, citation-source routing, and source export planning.
